...
<!-- class={`surface w-full min-w-[320px] max-w-[95vw] h-full p-5 m-0 rounded-xl drop-shadow-2xl transition-all sm:px-15 sm:py-10 md:max-h-[90vh] lg:max-w-[900px] lg:px-15`} -->
<main
  class={`surface w-full min-w-[320px] max-w-[95vw] h-[97vh] p-5 m-0 rounded-xl drop-shadow-2xl transition-all sm:px-15 sm:py-10 md:max-h-[90vh] lg:max-w-[900px] lg:px-15`}
>
  <slot />
